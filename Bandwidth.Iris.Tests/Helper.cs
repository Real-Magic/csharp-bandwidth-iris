...
namespace Bandwidth.Iris.Tests
{
    public class Helper
    {
        ...
        {
            return Client.GetInstance(AccountId, UserName, Password, baseUrl ?? "http://localhost:5423/");
        }
        ...
        public static void SetEnvironmetVariables(string baseUrl = null)
        {
            ...
            Environment.SetEnvironmentVariable(Client.BandwidthApiEndpoint, baseUrl ?? "http://localhost:5423/");
